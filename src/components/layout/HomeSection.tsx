...
const HomeSection = () => {
  ...
  return (
    <Container
      child={
        <div className="pb-64 xl:pb-32 relative z-20 mt-10 overflow-hidden" ref={ref}>
          <Button
            label="Contact Us"
            variant="secondary"
          ...
          />
          <motion.h1
            className="text-3xl xl:text-7xl font-bold text-center mt-8 xl:leading-22"
          ...
          <motion.p
            className="mt-4 xl:mt-8 text-base xl:text-xl text-center max-w-3xl mx-auto font-bold text-gray"
            initial={window.innerWidth > 1280 ? { opacity: 0, scale: 0 } : false}
            animate={inView && window.innerWidth > 1280 ? { opacity: 1, scale: 1 } : false}
            transition={{ duration: 0.3 }}
          >
          ...
          <div className="flex justify-between xl:justify-end items-center mt-8">
            <div className="px-6">
              <span className="block text-4xl font-bold mb-1">3000+</span>
              <span className="text-base xl:text-xl text-gray font-semibold">Certified Engineers</span>
            </div>
            <div className="h-8 w-0.5 bg-gray"></div>
            <div className="px-6">
              <span className="block text-4xl font-bold mb-1">300+</span>
              <span className="text-base xl:text-xl text-gray font-semibold">Global Clients</span>
            </div>
          </div>
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-12 cursor-default">
            <span className="block text-xs xl:text-sm -rotate-90">EXLORE NOW</span>
